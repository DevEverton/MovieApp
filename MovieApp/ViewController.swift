...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return ViewController.movies["Action"]!.count
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 0: videoCell.videoImage.image = ViewController.movies["Action"]?[indexPath.row]
        case 1: videoCell.videoImage.image = ViewController.movies["Drama"]?[indexPath.row]
        case 2: videoCell.videoImage.image = ViewController.movies["Science/Fiction"]?[indexPath.row]
        case 3: videoCell.videoImage.image = ViewController.movies["Kids"]?[indexPath.row]
        case 4: videoCell.videoImage.image = ViewController.movies["Horror"]?[indexPath.row]
        default: break
        }
